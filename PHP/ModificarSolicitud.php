...
<head>
	...
	<title>Modificar Solicitudes - Apartado de salas</title>
...
?>
	<br>
	<form class="consultaAdministrador" name="formularioConsulta" action="ModificarSolicitudResultado.php">
		<label>Ingrese Folio de la solicitud que desea modificar su status: </label>
		<input type="number" name="folio" min="1" placeholder="folio" style="width:50px" id="folio">
		<input type="hidden" name="correo"  id="correo">
		<select name="status" id="indicador">
		   <option value="Por decidir">Por decidir</option> 
		   <option value="Validada" style="color:green">Validar</option> 
		   <option value="Cancelada" style="color:red">Cancelar</option>
		   
		</select>
		<input type="submit"  value="Aplicar cambio" id="botonEnviar" onchange="activarBoton()" style="color:red"  class="btn btn-secundary btn-danger  ">
	</form>
