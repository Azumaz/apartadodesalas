...
<?php foreach ($link->query('select COUNT(*) as Total, A.recursosSeleccionados as Recursos, A.fecha as Fecha from solicitud  A GROUP BY A.recursosSeleccionados order by Fecha desc') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
<br>
		...
		<a href="ExportarUsoRecursos.php?t=word" target="_blank">Word</a>
		<a href="ExportarUsoRecursos.php?t=excel" target="_blank">Excel</a>
		</center>
</body>
</html>